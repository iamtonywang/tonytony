...
export default function Nigajun11View({ product, boardItems }: Props) {
  ...
  return (
    <article className={styles.detailPage}>
      ...
      <EditorialImageFrame
        src="/landing-assets/nigajun-11-section-01-v2.webp"
        alt=""
        priority
      />
      ...
      <EditorialImageFrame
        src="/landing-assets/nigajun-11-section-02-v2.webp"
        alt=""
      />
      ...
      <EditorialImageFrame
        src="/landing-assets/nigajun-11-section-03-v2.webp"
        alt=""
      />
      ...
      <EditorialImageFrame
        src="/landing-assets/nigajun-11-section-04-v2.webp"
        alt=""
      />
      ...
      <EditorialImageFrame
        src="/landing-assets/nigajun-11-section-05-v2.webp"
        alt=""
      />

      <SignatureLine />

      <section className={styles.landingSection} aria-label="Cleanse Deep Balance Naturally">
      ...
      <EditorialImageFrame
        src="/landing-assets/nigajun-11-section-06-v2.webp"
        alt=""
      />
