        ...
        <div className={styles.detailLowerCopyInner}>
          ...
          <p className={styles.detailLowerText}>
            <span className={styles.pcOnly}>
              ...
              <br />
              <br />
              이 지점에서 출발 치약을 단순한 세정 제품이 아니라 구강 조직의 <span className={styles.highlight20}>생물학적</span> 신호를 조절하는
              <br />
              <br />
              재정의했어.
              <br />
            ...
            <span className={styles.mobileOnly}>
              ...
              <br />
              잇몸 조직은 끊임없이 <span className={styles.highlight20}>염증 반응과 회복 과정을</span> 반복하는 생체 조직 Genetic Toothpaste 이 지점에서 출발
              <br />
