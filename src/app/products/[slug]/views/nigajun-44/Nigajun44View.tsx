      ...
      <section className={styles.informationSection}>
        ...
        {isInfoOpen && (
          <div className={styles.informationContent}>
            <p>
              <strong>사용방법 과 보관 및 규칙사항</strong>
            </p>

            <p>
              <strong>필수 사용 사항</strong>
            </p>
            <p>저녁 취침 전 사용</p>

            <p>
              <strong>절대 금지 사항</strong>
            </p>
            <p>타사 제품 혼용 금지</p>
            ...
            <p>44일 Soft 메이크업 사용 차단용 화장품 사용 금지</p>
            ...
            <p>[사용할 때의 주의사항]</p>
            <p>정보 보기</p>
            <p>화장품 사용 시 또는 사용 후 직사광선에 의하여</p>
            <p>사용 부위가 붉은 반점, 부어오름 또는 가려움증 등의</p>
            <p>이상 증상이나 부작용이 있는 경우에는</p>
            <p>전문의 등과 상담할 것</p>
            <p>상처가 있는 부위 등에는 사용을 자제할 것</p>

            <p>
              <strong>보관 및 취급 시 주의사항 정보 보기</strong>
            </p>
            <p>어린이의 손이 닿지 않는 곳에 보관할 것</p>
            <p>직사광선을 피해서 보관할 것</p>
            ...
            <p>용량 50ML</p>
            <p>제품주요사항 얼굴 피부용</p>
            <p>사용 기한 제조일로부터 18개월 / 개봉 후 8개월</p>

            <p>
              <strong>사용 방법</strong>
            </p>
            <p>아침·저녁 적당량을 얼굴 전체에 두텁게 흡수</p>

            <p>제품 개발사 TONYWANG</p>
            <p>화장품 제조업자 제품 내 별도 표기</p>
            <p>화장품 판매업자 제품 내 별도 표기</p>
            <p>제조국 대한민국</p>
            <p>기능성 심사 필 여부 _</p>
            <p>소비자 상담실 070 4488 8800</p>
            <p>
