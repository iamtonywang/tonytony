...
export default function Nigajun55View({ product, boardItems }: Props) {
  ...
  return (
    <article className={styles.detailPage}>
      ...
      <div className={styles.introCopySection}>
        <p className={styles.introCopyTitle}>Gentle Care Begins with Balanced Skin</p>
        <p className={styles.introCopyBody}>
          Experience daily freshness with a gentle cleansing formula enriched with a Mixed Protein
          Complex. Designed to leave your skin feeling clean, hydrated, and comfortably balanced
          every day.
        </p>
      </div>
      ...
      <section className={styles.landingSection} aria-label="Mixed Protein Complex">
        <p className={styles.sectionTitle}>
          Powered by a Unique Mixed Protein Complex
        </p>
        <p className={styles.bodyCopy}>
          Our carefully selected protein blend helps nourish the skin, maintain moisture, and
          support the skin&apos;s natural protective barrier for lasting comfort and care.
        </p>
      </section>
      ...
      <section className={styles.purchaseSection} aria-label="Purchase">
        ...
        <p className={styles.brandTitle}>NIGAJUN 55</p>
        <p className={styles.sectionTitle}>feminine cleanser</p>
