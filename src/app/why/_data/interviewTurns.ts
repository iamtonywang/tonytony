export type InterviewSpeaker = "기자" | "TONYWANG";
export type InterviewTurn = { speaker: InterviewSpeaker; text: string };

/** INTERVIEW 01 — 사용자 제공 원문 (수정·축약 없음) */
export const INTERVIEW_01_TURNS: readonly { speaker: "기자" | "TONYWANG"; text: string }[] = [
...
export const INTERVIEW_02_TURNS: readonly { speaker: "기자" | "TONYWANG"; text: string }[] = [
...
export const INTERVIEW_03_TURNS: readonly { speaker: "기자" | "TONYWANG"; text: string }[] = [
...
export const INTERVIEW_04_TURNS: readonly { speaker: "기자" | "TONYWANG"; text: string }[] = [
  {
    speaker: "기자",
...
export const INTERVIEW_05_TURNS: readonly { speaker: "기자" | "TONYWANG"; text: string }[] = [
  {
    speaker: "TONYWANG",
...
export const INTERVIEW_06_TURNS: readonly { speaker: "기자" | "TONYWANG"; text: string }[] = [
...
export const INTERVIEW_07_TURNS: readonly { speaker: "기자" | "TONYWANG"; text: string }[] = [
  {
    speaker: "기자",
...
export const INTERVIEW_08_TURNS: readonly { speaker: "기자" | "TONYWANG"; text: string }[] = [
  {
    speaker: "기자",
