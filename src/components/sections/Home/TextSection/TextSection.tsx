      ...
      <div className={styles.statementVisualBlock}>
        <div className={styles.typoBlock}>
          ...
          <div className={styles.typoSecondaryBlock}>
            ...
            <p className={styles.typoSecondary}><span className={styles.typoEmphasis25}>28년 동안</span> 오직 식물세포유전자 단백질 한 분야만 연구한 생명 과학 연구소</p>
            <p className={styles.typoSecondary}>모든 연구는 단 하나 <span className={styles.typoEmphasisOrange}>식물세포유전자단백질</span> 개발이다</p>
          </div>
        </div>
