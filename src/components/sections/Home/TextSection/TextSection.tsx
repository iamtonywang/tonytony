        ...
        <div className={styles.statementVisualMedia}>
          ...
          <div className={styles.statementTextOverlay} aria-hidden="true">
            <div className={styles.statementTextInner}>
              <div className={styles.textLine + " " + styles.textHighlight}>HEY</div>
              ...
              <div className={styles.textLine + " " + styles.textHighlight}>창조란?</div>
              ...
              <div className={styles.textLine + " " + styles.textHighlight}>식물 세포 유전자 단백질</div>
              ...
              <div className={styles.textLine}>21Since 2025 August TONYWANG</div>
            </div>
          </div>
        </div>
      </div>
