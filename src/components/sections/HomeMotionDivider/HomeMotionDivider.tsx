  ...
  return (
    <section className={styles.dividerSection}>
      ...
      <div className={styles.editorialWrap}>
        <p className={styles.editorialKicker}>WHY NOW?</p>

        <h2 className={styles.editorialHeadline}>Why now?</h2>

        <p className={styles.editorialLead}>최초라는 것을 증명 하고자 나왔어</p>
        ...
        <div className={styles.yearsBlock}>
          ...
          <div className={styles.yearCopy}>
            ...
            <p>For 28 years,</p>
            <p>we have only researched and developed the substance of the divine.</p>
          </div>
        </div>
