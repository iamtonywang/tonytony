...
export default function HeroSection() {
  ...
  useEffect(() => {
		// Strict Mode: allow this effect to run twice; cleanup clears prior timer,
		// and this re-registers a fresh timer so one valid timer survives.
