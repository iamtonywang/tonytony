    ...
    <section className={styles.section}>
      ...
      <div className={styles.ourWorkBottomCopy}>
        ...
        <p className={styles.ourWorkBottomLine}>
          82억 인구 중에 우리가 겪는 실패와 성공도 한 부분이야 28년 생명공학 연구 개발을 하면서
        </p>
        <p className={styles.ourWorkBottomLine}>단 한번도 화장품 따위는 만들 생각이 없었다</p>
        <p className={styles.ourWorkBottomLine}>나는 이런 하찮은 것들은 취급하지도 않는다</p>
        <p className={styles.ourWorkBottomLine}>줄기세포, 리포좀 엑소좀 성장인자 나노입자 펩타이드</p>
        ...
        <p className={styles.ourWorkBottomLine}>SINCE May 2026</p>
      </div>
