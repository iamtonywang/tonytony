          ...
          <div className={styles.whyTextOverlay}>
            <div className={styles.whyTypographyWrap}>
              ...
              <div className={styles.whyTonyBlock}>
                ...
                <div className={styles.whyTonyLine}>세상 밖으로 나온 이유는 <span className={styles.wordTonyStrong}>NIGAJUN</span> 때문이야</div>
                <div className={styles.whyTonyLine}>나의 결실이자 <span className={styles.wordTonyMedium}>창조적 물질</span>을 세상에 알리고자 나왔어</div>
